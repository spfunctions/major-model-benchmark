...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate and run the SimpleFunctions major-model benchmark.")
    parser.add_argument("--models", type=Path, default=Path("model_roster.json"))
    parser.add_argument("--tasks", type=Path, default=Path("tasks/general_seed.jsonl"))
